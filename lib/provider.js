...
/* harmony export */   "config": () => /* reexport safe */ _config__WEBPACK_IMPORTED_MODULE_0__.configSchema,
...
/* harmony import */ var events__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1);
/* harmony import */ var events__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(events__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var atom_satisfy_dependencies__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9);
/* harmony import */ var atom_satisfy_dependencies__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(atom_satisfy_dependencies__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var child_process__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(3);
...
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(13);
/* harmony import */ var _package_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(8);
'use babel';
...
function provideBuilder() {
  return class SasscProvider extends events__WEBPACK_IMPORTED_MODULE_1__.EventEmitter {
    constructor(cwd) {
      super();
      this.cwd = cwd;
      atom.config.observe(`${_package_json__WEBPACK_IMPORTED_MODULE_5__.name}.customArguments`, () => this.emit('refresh'));
    }
    ...
    isEligible() {
      if ((0,_config__WEBPACK_IMPORTED_MODULE_0__.getConfig)('alwaysEligible') === true) {
        return true;
      }

      const cmd = (0,child_process__WEBPACK_IMPORTED_MODULE_3__.spawnSync)((0,_util__WEBPACK_IMPORTED_MODULE_4__.which)(), [(0,_config__WEBPACK_IMPORTED_MODULE_0__.getConfig)('pathToSass')]);
    ...
    settings() {
      const errorMatch = ['(?<message>Error: .*)\\n\\s+on line (?<line>\\d+) of (?<file>.*)\\n'];
      const pathToSass = (0,_config__WEBPACK_IMPORTED_MODULE_0__.getConfig)('pathToSass');
      const customArguments = (0,_config__WEBPACK_IMPORTED_MODULE_0__.getConfig)('customArguments').trim().split(' ');
      return [{
        name: 'SassC',
        exec: pathToSass,
...
async function activate() {
  if ((0,_config__WEBPACK_IMPORTED_MODULE_0__.getConfig)('manageDependencies') === true) {
    (0,atom_satisfy_dependencies__WEBPACK_IMPORTED_MODULE_2__.satisfyDependencies)(_package_json__WEBPACK_IMPORTED_MODULE_5__.name);
  }
}
...
/* harmony export */ });
/* harmony import */ var _package_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8);
...
function getConfig(key) {
  return atom.config.get(`${_package_json__WEBPACK_IMPORTED_MODULE_0__.name}.${key}`);
}
...
module.exports = JSON.parse("{\"name\":\"build-sassc\",\"version\":\"0.8.2\",\"description\":\"Atom Build provider for sassc, compiles Sass\",\"repository\":\"https://github.com/idleberg/atom-build-sassc\",\"license\":\"MIT\",\"keywords\":[\"buildprovider\",\"compile\",\"sass\",\"sassc\",\"css\",\"linter\",\"lint\"],\"main\":\"lib/provider.js\",\"engines\":{\"atom\":\">=1.0.0 <2.0.0\"},\"providedServices\":{\"builder\":{\"description\":\"Compiles Sass\",\"versions\":{\"2.0.0\":\"provideBuilder\"}}},\"package-deps\":[\"build\"],\"dependencies\":{\"atom-package-deps\":\"^4.3.1\"},\"devDependencies\":{\"babel-eslint\":\"^7.2.3\",\"coffeelint-stylish\":\"^0.1.2\",\"eslint\":\"^3.19.0\",\"eslint-config-atom-build\":\"^4.0.0\",\"gulp\":\"github:gulpjs/gulp#4.0\",\"gulp-coffeelint\":\"^0.6.0\",\"gulp-debug\":\"^3.1.0\",\"gulp-jshint\":\"^2.0.4\",\"gulp-jsonlint\":\"^1.2.0\",\"gulp-lesshint\":\"^3.0.1\",\"jshint\":\"^2.9.4\"},\"scripts\":{\"test\":\"gulp lint\"}}");
...
var _a = __webpack_require__(7), resolve = _a.resolve, sep = _a.sep;
var _b = __webpack_require__(6), fs = _b.promises, readFileSync = _b.readFileSync;
...
/* harmony export */ });
/* harmony import */ var os__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
/* harmony import */ var os__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(os__WEBPACK_IMPORTED_MODULE_0__);

function which() {
  return (0,os__WEBPACK_IMPORTED_MODULE_0__.platform)() === 'win32' ? 'where' : 'which';
}
